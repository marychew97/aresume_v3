...
<div class="container-fluid form-content" style="font-family: 'Baloo Bhai', cursive; background-color: #fff">
    <h6 style="color: #2B303A">My Resume Completion</h6>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="education" role="tabpanel" aria-labelledby="education-tab">
            ...
            <form method="POST" action="create-institution.php" id="create-institution" enctype='multipart/form-data'> 
        ...
        <div class="tab-pane fade" id="work" role="tabpanel" aria-labelledby="work-tab">
            <div style="margin-top: 50px">
                ...
                <form method="POST" action="create-work.php" id="create-work" enctype='multipart/form-data'> 
        ...
        <div class="tab-pane fade" id="image" role="tabpanel" aria-labelledby="image-tab">
            <div style="margin-top: 50px">
                ...
                <form method="POST" action="create-activities.php" id="create-activities" enctype='multipart/form-data'> 
        ...
        <div class="tab-pane fade" id="document" role="tabpanel" aria-labelledby="document-tab">
            <div style="margin-top: 50px">
                ...
                <form method="POST" action="create-award.php" id="create-award" enctype='multipart/form-data'> 
